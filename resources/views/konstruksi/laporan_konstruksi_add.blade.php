            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                        ...
                        <input type="text" id="PID_konstruksi" name="PID_konstruksi" class="form-control mb-2" value="">
                        ...
                        <input type="text" id="ID_SAP_konstruksi" name="ID_SAP_konstruksi" class="form-control mb-2" value="">
                        ...
                        <input type="text" id="NO_PR_Konstruksi" name="NO_PR_Konstruksi" class="form-control mb-2" value="">
                        ...
                        <input type="date" id="tanggal_PR" name="tanggal_PR" class="form-control mb-2" value="">
                        ...
                        <label for="jenis_order_id" class="col-form-label">Jenis Order: </label>
                            <select class="jenis_order_id form-control mb-2" name="jenis_order_id">
                                <option value="" selected>-- Pilih Jenis Order --</option>
                                @foreach ($jeniso as $jenis_order)
                                    <option value=<?= $jenis_order->nama_jenis_order ?>>{{ $jenis_order->nama_jenis_order }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group pt-4 pb-0 pr-5 mb-0">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            Tes Nilai Lokasi Auto Generated
                                        </div>
                                    </div>
                            ...
                            <input type="number" id="material_DRM" name="material_DRM" class="form-control mb-2" value="">
                            ...
                            <input type="number" id="jasa_DRM" name="jasa_DRM" class="form-control mb-2" value="">
                            ...
                            <input type="number" id="total_DRM" name="total_DRM" class="form-control mb-2" value="">
