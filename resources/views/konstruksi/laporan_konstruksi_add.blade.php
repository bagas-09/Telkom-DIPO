...
<script>
    ...
    if(jenisOrder.options[jenisOrder.selectedIndex].text === "Konsumer (Cons)" || jenisOrder.options[jenisOrder.selectedIndex].text === "HEM" || jenisOrder.options[jenisOrder.selectedIndex].text === "Node B" || jenisOrder.options[jenisOrder.selectedIndex].text === "Node B OLO (MTEL)"){
