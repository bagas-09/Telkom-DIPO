                ...
                <table class="table" style="overflow-x: auto;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if(Auth::user()->role != "Commerce")
                        <a class="btn btn-sm btn-danger" style="color: white" data-toggle="modal" data-target="#deleteLaporanKonstruksiModal{{ $admins->id }}">Delete</a>


                        {{-- MODAL DELETE --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteLaporanKonstruksiModal{{ $admins->id }}" data-backdrop="static">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer bg-whitesmoke br">
                                ...
                                <a class="btn btn-danger" {{-- href="{{ route('konstruksi.deleteLaporanKonstruksi', [$admins->id]) }}" --}} value="Delete">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
