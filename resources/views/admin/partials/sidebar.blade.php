<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="nav-item dropdown {{ $title==='Laporan Commerce' || $title==='Laporan Maintenance' || $title==='Laporan Konstruksi' ? 'active' : '' }}">
      <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Laporan</span></a>
      <ul class="dropdown-menu">
        <li class="{{ $title==='Laporan Commerce' ? ' active' : '' }}"><a class="nav-link" href="{{route('commerce.laporan.index')}}"><i class="fa fa-home"></i><span>Commerce</span></a></li>
