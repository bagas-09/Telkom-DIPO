                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                                    ...
                                    <input type="text" id="PID_maintenance_id" name="PID_maintenance_id" class="form-control @error('PID_maintenance_id') is-invalid @enderror mb-2" value="{{ old('PID_maintenance_id', $id) }}" readonly>
