...
<section class="section">
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="px-5 pt-4" style="font-size: 140%"><b>Laporan Maintenance</b></div>
                    <div class="px-5 pt-2 pb-0">Berikut merupakan Laporan Maintenance yang akan dinilai</div>
                    @foreach ($tlket as $laporan)
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                                    <label for="ID_tiket" class="col-form-label">ID Tiket Maintenance: </label>
                                    <input type="text"  class="form-control @error('ID_tiket') is-invalid @enderror mb-2" value="{{ old('ID_tiket', $laporan->slugt) }}" readonly>
                                    ...
                                    <input type="text" class="form-control @error('ID_SAP_maintenance') is-invalid @enderror mb-2" value="{{ old('ID_SAP_maintenance', $laporan->ID_SAP_maintenance) }}" readonly>
                                ...
                                @enderror
                                    ...
                                    <input type="text"  value="{{ old('datek', $laporan->datek) }}" class="form-control @error('datek') is-invalid @enderror mb-2" readonly>
                                    ...
                                    <label for="jenis_program_id" class="col-form-label">Program: </label>
                                    <input type="text" class="form-control @error('jenis_program_id') is-invalid @enderror mb-2" value="{{ old('jenis_program_id', $jenis_program_id[$laporan->jenis_program_id]) }}" readonly>
    
                                    {{-- <select class="jenis_program_id form-control @error('jenis_program_id') is-invalid @enderror mb-2" name="jenis_program_id" value="{{ old('jenis_program_id', $laporan->jenis_program_id) }}" id="inputProgram">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pr-5 mb-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('material_DRM', $laporan->material_DRM) }}" class="form-control @error('material_DRM') is-invalid @enderror mb-2"  readonly>  
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('jasa_DRM', $laporan->jasa_DRM) }}" class="form-control @error('jasa_DRM') is-invalid @enderror mb-2"  readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('total_DRM', $laporan->total_DRM) }}" class="form-control @error('total_DRM') is-invalid @enderror mb-2" readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('material_aktual_2', $laporan->material_aktual) }}" class="form-control mb-2"  readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('jasa_aktual_2', $laporan->jasa_aktual) }}" class="form-control mb-2"  readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('total_aktual_2', $laporan->total_aktual) }}" class="form-control mb-2" readonly>
                                    </div> 
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form id="cityForm" action="{{route('commerce.laporan.store_maintenance', [$id])}}" method="POST">
                        <div class="row">
                            @csrf
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                                    <label for="ID_tiket_id" class="col-form-label">ID Tiket maintenance: </label>
                                    <input type="text" id="ID_tiket_id" name="ID_tiket_id" class="form-control @error('ID_tiket_id') is-invalid @enderror mb-2" value="{{ old('ID_tiket_id', $id) }}" readonly>
                                    <span id="ID_tiket_id_error" style="display: none; color: red;">Field ID Tiket Kontruksi harus diisi!</span>
                                    @error('ID_tiket_id')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
