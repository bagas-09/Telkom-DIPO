                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                                    ...
                                    <input type="text" id="no_PO" name="no_PO" class="form-control @error('no_PO') is-invalid @enderror mb-2" value="{{ old('no_PO', $laporan->no_PO) }}" readonly>
                                    @error('no_PO')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                    ...
                                    <input type="date" id="tanggal_PO" name="tanggal_PO" class="form-control @error('tanggal_PO') is-invalid @enderror mb-2" value="{{ old('tanggal_PO', $laporan->tanggal_PO) }}">
                                    @error('tanggal_PO')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="text" id="No_SP" name="No_SP" class="form-control @error('No_SP') is-invalid @enderror mb-2" value="{{ old('No_SP', $laporan->No_SP) }}">
                                    @error('No_SP')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="date" id="tanggal_SP" name="tanggal_SP" class="form-control @error('tanggal_SP') is-invalid @enderror mb-2" value="{{ old('tanggal_SP', $laporan->tanggal_SP) }}">
                                    @error('tanggal_SP')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="date" id="TOC" name="TOC" class="form-control @error('TOC') is-invalid @enderror mb-2" value="{{ old('TOC', $laporan->TOC) }}">
                                    @error('TOC')
                                    <div class="invalid-feedback">
                                        TOC Wajib Diisi!!!
                                    </div>
                                    ...
                                    <input type="text" id="No_BAUT" name="No_BAUT" class="form-control @error('No_BAUT') is-invalid @enderror mb-2" value="{{ old('No_BAUT', $laporan->No_BAUT) }}">
                                    @error('No_BAUT')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="date" id="tanggal_BAUT" name="tanggal_BAUT" class="form-control @error('tanggal_BAUT') is-invalid @enderror mb-2" value="{{ old('tanggal_BAUT', $laporan->tanggal_BAUT) }}">
                                    @error('tanggal_BAUT')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pr-5 mb-0">
                                    ...
                                    <input type="text" id="NO_BAR" name="NO_BAR" class="form-control @error('NO_BAR') is-invalid @enderror mb-2" value="{{ old('NO_BAR', $laporan->NO_BAR) }}">
                                    @error('NO_BAR')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="date" id="tanggal_BAR" name="tanggal_BAR" class="form-control @error('tanggal_BAR') is-invalid @enderror mb-2" value="{{ old('tanggal_BAR', $laporan->tanggal_BAR) }}">
                                    @error('tanggal_BAR')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="text" id="NO_BAST" name="NO_BAST" class="form-control @error('NO_BAST') is-invalid @enderror mb-2" value="{{ old('NO_BAST', $laporan->NO_BAST) }}">
                                    @error('NO_BAST')
                                    <div class="invalid-feedback">
                                    ...
                                    <input type="date" id="tanggal_BAST" name="tanggal_BAST" class="form-control @error('tanggal_BAST') is-invalid @enderror mb-2" value="{{ old('tanggal_BAST', $laporan->tanggal_BAST) }}">
                                    @error('tanggal_BAST')
                                    <div class="invalid-feedback">
