                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pr-5 mb-0">
                                    ...
                                    <label for="total_aktual_2_2" class="col-form-label">Material DRM: </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                Rp.
                                    ...
                                    <span id="total_aktual_2_error" style="display: none; color: red;">Field Material DRM harus diisi!</span>
                                    ...
                                    <label for="jasa_DRM_2_2" class="col-form-label">Jasa DRM: </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                Rp.
                                        ...
                                        <input type="text" value="{{ old('jasa_DRM_2', $laporan->jasa_DRM) }}" class="form-control @error('jasa_DRM_2') is-invalid @enderror mb-2"  readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('total_DRM_2', $laporan->total_DRM) }}" class="form-control @error('total_DRM_2') is-invalid @enderror mb-2" readonly>
                                    </div>
