    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @foreach ($maintenance as $laporan)
                <form action="{{route('maintenance.updateLaporanMaintenance', [$id])}}" method="POST">
                @csrf    
                <div class="row">
                    <div class="col-lg-6">
                    <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                        ...
                        <input type="text" id="ID_SAP_maintenance" name="ID_SAP_maintenance" class="form-control @error('ID_SAP_maintenance') is-invalid @enderror mb-2" value="{{ old('ID_SAP_maintenance', $laporan->slugm) }}" readonly>
                    ...
                    <div class="d-flex justify-content-end pr-5 mb-5">
                        <button class="btn btn-primary" value="Simpan Data" type="submit">Simpan</button>
                    </div>
                </div>
            </form>
            @endforeach
